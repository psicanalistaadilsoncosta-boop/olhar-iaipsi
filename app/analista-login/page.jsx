    ...
    >
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 rounded-xl text-sm font-medium text-stone-800 border border-stone-200 bg-white flex items-center justify-center gap-3 hover:bg-stone-50 transition-colors disabled:opacity-60"
        >
